...
python train_emernerf.py \
    --eval_only \
    --config_file /home/ubuntu/Workspace/phat-intern-dev/VinAI/EmerNeRF/work_dirs/0812/feature_lifting_nuscenes/001_flow_nuscene/config.yaml \
    --output_root $output_root \
    --project $project \
    --run_name ${scene_idx}_flow_nuscene \
    --render_data_video /home/ubuntu/Workspace/phat-intern-dev/VinAI/EmerNeRF/work_dirs/0812/feature_lifting_nuscenes/001_flow_nuscene/full_videos \
